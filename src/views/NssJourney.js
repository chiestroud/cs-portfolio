  ...
  return (
    <section>
      <div className="head">
        ...
        <p className="nssJourneyContent">I became obsessed with learning web development and decided to join the Web Developer Bootcamp offered by the Nashville Software School in January 2021. I wanted to keep track of my progress during the course of study. I spent a couple of hours at the beginning of every month to build a journal site to log my daily school activity. Click the image to go to the desired site.</p>
      </div>
