  ...
  return (
    <section className="aboutMe">
      ...
      <div className="mainContainer">
        ...
        <img className="profileImg" src='https://lh3.googleusercontent.com/T8-u0QEx7WRsayMekrNsXpaYG9atXKs6OyfJIjZfeor8YPiky7gNjP862t33eWs_tnTlOa9FsZ2lzsqBPBwQCsR_kmMd4Qpe25XPOLO0Xbgm2p5PEgF_r-r8ivd3TnNE8Ft5gljFqI4=w600-h315-p-k' />
      </div>
    </section>
  );
}
